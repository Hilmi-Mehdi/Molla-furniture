...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{!! asset('assets/images/icons/favicon32x32.png') !!}">
    <link rel="icon" type="image/png" sizes="16x16" href="{!! asset('assets/images/icons/favicon16x16.png') !!}">
                    ...
                    <div class="header-left">
                        ...
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    <a href="category.html" class="sf-with-ul">Products</a>
                                </li>
                                <li>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-md-6">
                                                <div class="menu-col">
                                                    ...
                                                    <ul>
                                                        <li><a href="product.html">Promos</a></li>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{!! asset('assets/images/products/cart/product_1.jpg') !!}" alt="product">
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product">
                                        ...
                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{!! asset('assets/images/products/cart/product_2.jpg') !!}" alt="product">
                                            </a>
                                        </figure>
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                                ...
                                <div class="intro-slider intro-slider-1 owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                <source media="(max-width: 480px)" srcset="{!! asset('assets/images/slider/slide_1_480w.jpg') !!}">
                                                <img src="{!! asset('assets/images/slider/slide_1.jpg') !!}" alt="Image Desc">
                                            </picture>
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                <source media="(max-width: 480px)" srcset="{!! asset('assets/images/slider/slide_2_480w.jpg') !!}">
                                                <img src="{!! asset('assets/images/slider/slide_2.jpg') !!}" alt="Image Desc">
                                            </picture>
                                        </figure><!-- End .slide-image -->
                                    ...
                                    <div class="intro-slide">
                                        <figure class="slide-image">
                                            <picture>
                                                <source media="(max-width: 480px)" srcset="{!! asset('assets/images/slider/slide_3_480w.jpg') !!}">
                                                <img src="{!! asset('assets/images/slider/slide_3.jpg') !!}" alt="Image Desc">
                                            </picture>
                                        </figure><!-- End .slide-image -->
                                ...
                                <div class="row row-sm">
                                    <div class="col-md-6 col-lg-12">
                                        <div class="banner banner-display">
                                            <a href="#">
                                                <img src="{!! asset('assets/images/banners/home/intro/banner_1.jpg') !!}" alt="Banner">
                                            </a>
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="banner banner-display mb-0">
                                            <a href="#">
                                                <img src="{!! asset('assets/images/banners/home/intro/banner_2.jpg') !!}" alt="Banner">
                                            </a>
                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_1_1.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_1_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_2_1.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_2_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_3_1.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_3_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_4_1.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_4_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_5_1.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_5_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_6_1.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product_6_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
        		...
        		<div class="row">
        			<div class="col-6 col-lg-4">
        				<div class="banner banner-display banner-link-anim">
                			<a href="#">
                				<img src="{!! asset('assets/images/banners/home/banner_1.jpg') !!}" alt="Banner">
                			</a>
        			...
        			<div class="col-6 col-lg-4 order-lg-last">
        				<div class="banner banner-display banner-link-anim">
                			<a href="#">
                				<img src="{!! asset('assets/images/banners/home/banner_4.jpg') !!}" alt="Banner">
                			</a>
        			...
        			<div class="col-sm-12 col-lg-4 banners-sm">
                        <div class="row">
            				<div class="banner banner-display banner-link-anim col-lg-12 col-6">
                    			<a href="#">
                    				<img src="{!! asset('assets/images/banners/home/banner_2.jpg') !!}" alt="Banner">
                    			</a>
                			...
                			<div class="banner banner-display banner-link-anim col-lg-12 col-6">
                    			<a href="#">
                    				<img src="{!! asset('assets/images/banners/home/banner_3.jpg') !!}" alt="Banner">
                    			</a>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_12_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_12_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_10_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_10_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">NEW</span>
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_9_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_9_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_8_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_8_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_11_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_11_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_13_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_13_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_14_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_14_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">NEW</span>
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_16_1.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product_16_2.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                    ...
                    <div class="owl-carousel owl-simple carousel-with-shadow" data-toggle="owl" 
                        ...
                        <article class="entry entry-display">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{!! asset('assets/images/blog/home/post_1.jpg') !!}" alt="image desc">
                                </a>
                        ...
                        <article class="entry entry-display">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{!! asset('assets/images/blog/home/post_2.jpg') !!}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
                        ...
                        <article class="entry entry-display">
                            <figure class="entry-media">
                                <a href="single.html">
                                    <img src="{!! asset('assets/images/blog/home/post_3.jpg') !!}" alt="image desc">
                                </a>
                            </figure><!-- End .entry-media -->
            ...
            <div class="col-10">
                <div class="row no-gutters bg-white newsletter-popup-content">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="{!! asset('assets/images/popup/newsletter/img_1.jpg') !!}" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
