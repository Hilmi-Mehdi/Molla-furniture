                        ...
                        <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product11.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product12.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product21.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product22.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product31.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product32.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    ...
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product41.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product42.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product51.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product52.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
                            ...
                            <div class="product product-11 text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product61.jpg') !!}" alt="Product image" class="product-image">
                                        <img src="{!! asset('assets/images/demos/demo-2/products/product62.jpg') !!}" alt="Product image" class="product-image-hover">
                                    </a>
        		...
        		<div class="row">
        			...
        			<div class="col-sm-12 col-lg-4 banners-sm">
                        <div class="row">
                			...
                			<div class="banner banner-display banner-link-anim col-lg-12 col-6">
                    			<a href="#">
                    				<img src="{!! asset('assets/images/banners/home/banner3.jpg') !!}" alt="Banner">
                    			</a>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product121.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product122.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product101.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product102.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">NEW</span>
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product91.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product92.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product81.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product82.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product111.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product112.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product131.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product132.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product141.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product142.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="product product-11 mt-v3 text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-new">NEW</span>
                                            <a href="product.html">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product161.jpg') !!}" alt="Product image" class="product-image">
                                                <img src="{!! asset('assets/images/demos/demo-2/products/product162.jpg') !!}" alt="Product image" class="product-image-hover">
                                            </a>
