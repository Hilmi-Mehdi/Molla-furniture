    ...
    <tbody>
        @foreach($categories as $category)
            <tr>
                ...
                <td>
                    <a href="{{ route('category.show', $category) }}" class="btn btn-info"><i class="fa-solid fa-eye"></i></a>
                    <a href="{{ route('category.edit', $category) }}" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
